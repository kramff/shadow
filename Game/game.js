...
let createPlayerMesh = (playerObject) => {
	...
	// Point light
	let newPlayerPointLight = new THREE.PointLight(0xffffff, 0.3, 5);
	scene.add(newPlayerPointLight);
	newPlayerPointLight.parent = newPlayerMesh;
	// Spot light
	let newPlayerSpotLight = new THREE.SpotLight(0xffffff, 0.3, 5, 0.2, 0.5, 2);
	scene.add(newPlayerSpotLight);
	newPlayerSpotLight.parent = newPlayerMesh;
